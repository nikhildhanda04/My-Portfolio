const skill = () =>{
    return(
        <div className="bg-[#363150] px-[130px] pt-[190px] pb-[50px]">
            ...
            Things that holds value, which are visually appealing and attention grabbing
            </p>
            <div className="flex justify-end mt-[-90px] ">
            <button className="bg-blue-950 rounded-full p-3 text-[white] text-[20px] font-[gothic] hover:text-[yellow]">
